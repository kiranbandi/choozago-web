		        ...
		        <div className='not-found container m-t'>
		          <div className="alert alert-danger text-center" role="alert">
					...
					<div className="well well-lg align-center">
					    <strong>Seems like you took a wrong turn and landed here or maybe our developer has been too lazy and the page you
					    are trying to view is still under development . But then we do need to cut him some slack as its apparent below he
